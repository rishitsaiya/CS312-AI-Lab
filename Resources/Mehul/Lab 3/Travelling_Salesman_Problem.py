...
class simulated_annealing:
	def __init__(self, number_of_towns, towns, cooling_rate, initial_temperature, closing_temperature, closing_iterations):
		...
		# self.l = [self.current_solution.calculate_cost_of_state()]
		self.best_solution = self.current_solution
		# print (self.current_solution.get_ordering())
	def get_next_solution(self):
		...
		while (True):
			...
			# self.l.append(i.calculate_cost_of_state())
			random_number = random.random()
			if probability > random_number:
				# print ("Neighbouring Cost: ", end = "")
				# print (neighbouring_cost, end = "\t probability: ")
				# print (probability, end = "\t best cost: ")
				# print (i.calculate_cost_of_state(), end = "\t Current Temp: ")
	...
	def run_sim(self):
		# print ("In runsim")
		# print ("current_iteration: ", str(self.current_iteration))
		# print ("current_temperature: ", str(self.current_temperature))
		# print ("closing_iterations: ", str(self.closing_iterations))
		# print ("closing_temperature: ", str(self.closing_temperature))
		while ((self.current_iteration < self.closing_iterations) and (self.current_temperature > self.closing_temperature)):
			...
			# if (self.current_iteration == self.closing_iterations):
			# 	print ("Breaking due to iterations")
...
class genetic_algorithm:
	def __init__(self, number_of_towns, towns, initial_solution_size, crossover_algorirhm, mutation_prob, terminating_iterations):
		...
		# print (sorted(initial_solutions, key = attrgetter("cost")))
	...
	def run_model(self):
		for i in range(self.terminating_iterations):
			...
			# print ("; Current Best:", self.current_solutions[0].calculate_cost_of_state(), end = "; ")
			# print ("; New1: ", new_1.calculate_cost_of_state(), "; New2: ", new_2.calculate_cost_of_state())
...
class ant_colony_optimisation:
	...
	def run_ants(self):
		min = -1
		best_solution = solution([i for i in range(100)], self.towns)
...
def main():
	...
	genetic1 = genetic_algorithm(number_of_towns, towns, 100, Order_Crossover, 0.8, 20000)
	...
	ants1 = ant_colony_optimisation(number_of_towns, towns, 2, 1.0, 10.0, 0.5, 10, initial_pheromone, 10000)
